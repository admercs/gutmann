...
;;NOTE ENVI FILES MUST BE RESTORED BEFORE THIS WILL COMPILE!!
;;NOTE ENVI FILES MUST BE RESTORED BEFORE THIS WILL COMPILE!!
pro lowemres, avfile, emfile, outfile
nem=3
makenewfile = 0
...
readu, emfid, iendmem
free_lun, emfid		;;init endmember will be used to restore spectral after spatial
endmem=iendmem		;;endmember will be spectrally resampled
curendmem=endmem	;;curendmember will be radiometrically resampled
lowendmem=endmem	;;low spatial res endmember
flowem=lowendmem	;;full radiometric low spatial res endmember
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;create "map" unmix_doit again for lower resolution endmembers
...
writeu, outfid, float((2^i) + 1000),float(2^j),float(2^k),float(EMabundance), Float(truEMabundance)
...
endmem=curendmem
lowendmem=float(fix(lowendmem/2))
...
for m=0, (cnb-1) do begin
	...
	flowem(m,*)=float(fix((flowem(m*2,*)+flowem(m*2+1,*))/2))
endfor
endmem=fendmem(0:cnb-1, *)	;;restore radiometry of endmembers
fendmem=endmem
curendmem=endmem
lowendmem=flowem(0:cnb-1,*)
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;
;;now we will find the "new" endmembers available at the lower resolution
;;	and recalculate the map based on those endmembers
;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
lowendmem=flowem
for lowindex=0, nem-1 do begin
	lowendmem(*,lowindex)=curAv(where(map(*,*,lowindex) eq max(map(*,*,lowindex))))
endfor
envi_file_mng, id=mapfid, /remove
