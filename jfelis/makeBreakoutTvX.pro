...
PRO makeBreakoutTvX, inputfile, fast=fast, plotNcovers=plotNcovers
...
;; loop over resolution (2^x) 1km -> 32km
        ...
        plotTvXBreakout, maskFileNames, plotFile, LandCover, $
...
;          lowx=10000, hix=20000, lowy=14500, hiy=17000
        FOR resolution=1,5 DO BEGIN
           ...
           print, "Resizeing Land Cover"
           LandCover=resizeLandCover(LandCover, curRes/oldres, curRes)
           print, "Resizeing Data Files"
           resFiles=changeResolution(maskFileNames,curRes/oldres, curRes)
           print, "plotting : ", plotFile
           plotTvXBreakout, resFiles, plotFile+'.ps', LandCover, $
