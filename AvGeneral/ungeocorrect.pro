pro ungeocorrect, imgfname, ns, nl, nb, nloffset, gltfname, gltns, gltnl,ofname
...
;          ofname - output file name will be output in BIP
;
;;NOTE	this program will not work for large files because it reads the ENTIRE file
